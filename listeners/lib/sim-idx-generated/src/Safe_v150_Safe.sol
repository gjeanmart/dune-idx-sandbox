...
struct Safe_v150_Safe$AddedOwnerEventParams {
    address owner;
}

struct Safe_v150_Safe$ApproveHashEventParams {
    bytes32 approvedHash;
    address owner;
}

struct Safe_v150_Safe$ChangedFallbackHandlerEventParams {
    address handler;
}

struct Safe_v150_Safe$ChangedGuardEventParams {
    address guard;
}

struct Safe_v150_Safe$ChangedModuleGuardEventParams {
    address moduleGuard;
}

struct Safe_v150_Safe$ChangedThresholdEventParams {
    uint256 threshold;
}

struct Safe_v150_Safe$DisabledModuleEventParams {
    address module;
}

struct Safe_v150_Safe$EnabledModuleEventParams {
    address module;
}

struct Safe_v150_Safe$ExecutionFailureEventParams {
    bytes32 txHash;
    uint256 payment;
}

struct Safe_v150_Safe$ExecutionFromModuleFailureEventParams {
    address module;
}

struct Safe_v150_Safe$ExecutionFromModuleSuccessEventParams {
    address module;
}

struct Safe_v150_Safe$ExecutionSuccessEventParams {
    bytes32 txHash;
    uint256 payment;
}

struct Safe_v150_Safe$RemovedOwnerEventParams {
    address owner;
}

struct Safe_v150_Safe$SafeReceivedEventParams {
    address sender;
    uint256 value;
}
...
struct Safe_v150_Safe$SignMsgEventParams {
    bytes32 msgHash;
}

abstract contract Safe_v150_Safe$OnAddedOwnerEvent {
    function Safe_v150_Safe$onAddedOwnerEvent(EventContext memory ctx, Safe_v150_Safe$AddedOwnerEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnAddedOwnerEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x9465fa0c962cc76958e6373a993326400c1c94f8be2fe3a952adfa7f60b2ea26),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onAddedOwnerEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnApproveHashEvent {
    function Safe_v150_Safe$onApproveHashEvent(EventContext memory ctx, Safe_v150_Safe$ApproveHashEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnApproveHashEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xf2a0eb156472d1440255b0d7c1e19cc07115d1051fe605b0dce69acfec884d9c),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onApproveHashEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnChangedFallbackHandlerEvent {
    function Safe_v150_Safe$onChangedFallbackHandlerEvent(EventContext memory ctx, Safe_v150_Safe$ChangedFallbackHandlerEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnChangedFallbackHandlerEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x5ac6c46c93c8d0e53714ba3b53db3e7c046da994313d7ed0d192028bc7c228b0),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onChangedFallbackHandlerEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnChangedGuardEvent {
    function Safe_v150_Safe$onChangedGuardEvent(EventContext memory ctx, Safe_v150_Safe$ChangedGuardEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnChangedGuardEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x1151116914515bc0891ff9047a6cb32cf902546f83066499bcf8ba33d2353fa2),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onChangedGuardEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnChangedModuleGuardEvent {
    function Safe_v150_Safe$onChangedModuleGuardEvent(EventContext memory ctx, Safe_v150_Safe$ChangedModuleGuardEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnChangedModuleGuardEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xcd1966d6be16bc0c030cc741a06c6e0efaf8d00de2c8b6a9e11827e125de8bb8),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onChangedModuleGuardEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnChangedThresholdEvent {
    function Safe_v150_Safe$onChangedThresholdEvent(EventContext memory ctx, Safe_v150_Safe$ChangedThresholdEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnChangedThresholdEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x610f7ff2b304ae8903c3de74c60c6ab1f7d6226b3f52c5161905bb5ad4039c93),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onChangedThresholdEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnDisabledModuleEvent {
    function Safe_v150_Safe$onDisabledModuleEvent(EventContext memory ctx, Safe_v150_Safe$DisabledModuleEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnDisabledModuleEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xaab4fa2b463f581b2b32cb3b7e3b704b9ce37cc209b5fb4d77e593ace4054276),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onDisabledModuleEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnEnabledModuleEvent {
    function Safe_v150_Safe$onEnabledModuleEvent(EventContext memory ctx, Safe_v150_Safe$EnabledModuleEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnEnabledModuleEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xecdf3a3effea5783a3c4c2140e677577666428d44ed9d474a0b3a4c9943f8440),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onEnabledModuleEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnExecutionFailureEvent {
    function Safe_v150_Safe$onExecutionFailureEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionFailureEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnExecutionFailureEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x23428b18acfb3ea64b08dc0c1d296ea9c09702c09083ca5272e64d115b687d23),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onExecutionFailureEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnExecutionFromModuleFailureEvent {
    function Safe_v150_Safe$onExecutionFromModuleFailureEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionFromModuleFailureEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnExecutionFromModuleFailureEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xacd2c8702804128fdb0db2bb49f6d127dd0181c13fd45dbfe16de0930e2bd375),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onExecutionFromModuleFailureEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnExecutionFromModuleSuccessEvent {
    function Safe_v150_Safe$onExecutionFromModuleSuccessEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionFromModuleSuccessEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnExecutionFromModuleSuccessEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x6895c13664aa4f67288b25d7a21d7aaa34916e355fb9b6fae0a139a9085becb8),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onExecutionFromModuleSuccessEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnExecutionSuccessEvent {
    function Safe_v150_Safe$onExecutionSuccessEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionSuccessEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnExecutionSuccessEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x442e715f626346e8c54381002da614f62bee8d27386535b2521ec8540898556e),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onExecutionSuccessEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnRemovedOwnerEvent {
    function Safe_v150_Safe$onRemovedOwnerEvent(EventContext memory ctx, Safe_v150_Safe$RemovedOwnerEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnRemovedOwnerEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xf8d49fc529812e9a7c5c50e69c20f0dccc0db8fa95c98bc58cc9a4f1c1299eaf),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onRemovedOwnerEvent.selector
        });
    }
}

abstract contract Safe_v150_Safe$OnSafeReceivedEvent {
    function Safe_v150_Safe$onSafeReceivedEvent(EventContext memory ctx, Safe_v150_Safe$SafeReceivedEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnSafeReceivedEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0x3d0ce9bfc3ed7d6862dbb28b2dea94561fe714a1b4d019aa8af39730d1ad7c3d),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onSafeReceivedEvent.selector
        });
    }
}
...
abstract contract Safe_v150_Safe$OnSignMsgEvent {
    function Safe_v150_Safe$onSignMsgEvent(EventContext memory ctx, Safe_v150_Safe$SignMsgEventParams memory inputs) virtual external;

    function Safe_v150_Safe$triggerOnSignMsgEvent() view external returns (Trigger memory) {
        return Trigger({
            abiName: "Safe_v150_Safe",
            selector: bytes32(0xe7f4675038f4f6034dfcbbb24c4dc08e4ebf10eb9d257d3d02c0f38d122ac6e4),
            triggerType: TriggerType.EVENT,
            listenerCodehash: address(this).codehash,
            handlerSelector: this.Safe_v150_Safe$onSignMsgEvent.selector
        });
    }
}
...
contract Safe_v150_Safe$EmitAllEvents is
  Safe_v150_Safe$OnAddedOwnerEvent,
Safe_v150_Safe$OnApproveHashEvent,
Safe_v150_Safe$OnChangedFallbackHandlerEvent,
Safe_v150_Safe$OnChangedGuardEvent,
Safe_v150_Safe$OnChangedModuleGuardEvent,
Safe_v150_Safe$OnChangedThresholdEvent,
Safe_v150_Safe$OnDisabledModuleEvent,
Safe_v150_Safe$OnEnabledModuleEvent,
Safe_v150_Safe$OnExecutionFailureEvent,
Safe_v150_Safe$OnExecutionFromModuleFailureEvent,
Safe_v150_Safe$OnExecutionFromModuleSuccessEvent,
Safe_v150_Safe$OnExecutionSuccessEvent,
Safe_v150_Safe$OnRemovedOwnerEvent,
Safe_v150_Safe$OnSafeReceivedEvent,
Safe_v150_Safe$OnSafeSetupEvent,
Safe_v150_Safe$OnSignMsgEvent
{
...
event SignMsg(bytes32 msgHash);
  ...
  function Safe_v150_Safe$onAddedOwnerEvent(EventContext memory ctx, Safe_v150_Safe$AddedOwnerEventParams memory inputs) virtual external override {
    emit AddedOwner(inputs.owner);
  }
function Safe_v150_Safe$onApproveHashEvent(EventContext memory ctx, Safe_v150_Safe$ApproveHashEventParams memory inputs) virtual external override {
    emit ApproveHash(inputs.approvedHash, inputs.owner);
  }
function Safe_v150_Safe$onChangedFallbackHandlerEvent(EventContext memory ctx, Safe_v150_Safe$ChangedFallbackHandlerEventParams memory inputs) virtual external override {
    emit ChangedFallbackHandler(inputs.handler);
  }
function Safe_v150_Safe$onChangedGuardEvent(EventContext memory ctx, Safe_v150_Safe$ChangedGuardEventParams memory inputs) virtual external override {
    emit ChangedGuard(inputs.guard);
  }
function Safe_v150_Safe$onChangedModuleGuardEvent(EventContext memory ctx, Safe_v150_Safe$ChangedModuleGuardEventParams memory inputs) virtual external override {
    emit ChangedModuleGuard(inputs.moduleGuard);
  }
function Safe_v150_Safe$onChangedThresholdEvent(EventContext memory ctx, Safe_v150_Safe$ChangedThresholdEventParams memory inputs) virtual external override {
    emit ChangedThreshold(inputs.threshold);
  }
function Safe_v150_Safe$onDisabledModuleEvent(EventContext memory ctx, Safe_v150_Safe$DisabledModuleEventParams memory inputs) virtual external override {
    emit DisabledModule(inputs.module);
  }
function Safe_v150_Safe$onEnabledModuleEvent(EventContext memory ctx, Safe_v150_Safe$EnabledModuleEventParams memory inputs) virtual external override {
    emit EnabledModule(inputs.module);
  }
function Safe_v150_Safe$onExecutionFailureEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionFailureEventParams memory inputs) virtual external override {
    emit ExecutionFailure(inputs.txHash, inputs.payment);
  }
function Safe_v150_Safe$onExecutionFromModuleFailureEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionFromModuleFailureEventParams memory inputs) virtual external override {
    emit ExecutionFromModuleFailure(inputs.module);
  }
function Safe_v150_Safe$onExecutionFromModuleSuccessEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionFromModuleSuccessEventParams memory inputs) virtual external override {
    emit ExecutionFromModuleSuccess(inputs.module);
  }
function Safe_v150_Safe$onExecutionSuccessEvent(EventContext memory ctx, Safe_v150_Safe$ExecutionSuccessEventParams memory inputs) virtual external override {
    emit ExecutionSuccess(inputs.txHash, inputs.payment);
  }
function Safe_v150_Safe$onRemovedOwnerEvent(EventContext memory ctx, Safe_v150_Safe$RemovedOwnerEventParams memory inputs) virtual external override {
    emit RemovedOwner(inputs.owner);
  }
function Safe_v150_Safe$onSafeReceivedEvent(EventContext memory ctx, Safe_v150_Safe$SafeReceivedEventParams memory inputs) virtual external override {
...
function Safe_v150_Safe$onSignMsgEvent(EventContext memory ctx, Safe_v150_Safe$SignMsgEventParams memory inputs) virtual external override {
    emit SignMsg(inputs.msgHash);
  }

  function allTriggers() view external returns (Trigger[] memory) {
    Trigger[] memory triggers = new Trigger[](16);
    triggers[0] = this.Safe_v150_Safe$triggerOnAddedOwnerEvent();
    triggers[1] = this.Safe_v150_Safe$triggerOnApproveHashEvent();
    triggers[2] = this.Safe_v150_Safe$triggerOnChangedFallbackHandlerEvent();
    triggers[3] = this.Safe_v150_Safe$triggerOnChangedGuardEvent();
    triggers[4] = this.Safe_v150_Safe$triggerOnChangedModuleGuardEvent();
    triggers[5] = this.Safe_v150_Safe$triggerOnChangedThresholdEvent();
    triggers[6] = this.Safe_v150_Safe$triggerOnDisabledModuleEvent();
    triggers[7] = this.Safe_v150_Safe$triggerOnEnabledModuleEvent();
    triggers[8] = this.Safe_v150_Safe$triggerOnExecutionFailureEvent();
    triggers[9] = this.Safe_v150_Safe$triggerOnExecutionFromModuleFailureEvent();
    triggers[10] = this.Safe_v150_Safe$triggerOnExecutionFromModuleSuccessEvent();
    triggers[11] = this.Safe_v150_Safe$triggerOnExecutionSuccessEvent();
    triggers[12] = this.Safe_v150_Safe$triggerOnRemovedOwnerEvent();
    triggers[13] = this.Safe_v150_Safe$triggerOnSafeReceivedEvent();
    triggers[14] = this.Safe_v150_Safe$triggerOnSafeSetupEvent();
    triggers[15] = this.Safe_v150_Safe$triggerOnSignMsgEvent();
    return triggers;
  }
}